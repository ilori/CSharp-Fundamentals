namespace Forum.App
{
    ...
    internal class MenuController
    {
        ...
        {
            this.Username = ((IReadUserInfoController) this.CurrentController).Username;
            this.LogInUser();
        ...
        private void OpenCategory()
        {
            ...
            var categoryCrtlr = (CategoryController) this.controllers[(int) MenuState.OpenCategory];

            categoryCrtlr.SetCategory(categoryIndex);
